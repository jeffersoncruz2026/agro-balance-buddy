-- Abertura do Resultado Financeiro: detalha DESPESAS FINANCEIRAS e RECEITAS
-- FINANCEIRAS por natureza (nomeconta) e por mês, para uma safra inteira.
...
-- Drill-down: lançamentos que compõem uma natureza (nomeconta) específica
-- dentro de DESPESAS FINANCEIRAS ou RECEITAS FINANCEIRAS, numa safra.
